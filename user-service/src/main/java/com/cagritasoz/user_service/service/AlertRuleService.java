...
public class AlertRuleService {
    ...
    public AlertRuleResponse createAlertRule(Long userId, AlertRuleRequest request) {
        ...
        final AlertRule alertRule = AlertRule.builder()
                ...
                .scope(scope)
                .enabled(Objects.requireNonNullElse(request.enabled(), Boolean.TRUE)) // If enabled is omitted (null), use the default matching the database.
                .build();
    ...
    public AlertRuleResponse updateAlertRule(Long userId, Long ruleId, AlertRuleRequest request) {
        ...
        // at this point in the method and would return stale data, would not correctly reflect last updatedAt time.
        ...
        // business logic ever demands that the event payload's timestamp occurredAt exactly matches the
